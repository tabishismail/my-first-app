function Intro() {
    return (
        <div>
            <h1>TABISH MUHAMMAD ISMAIL</h1>
            <hr />
            <h2>PROFESSIONAL FOCUS AND OBJECTIVE</h2>
            <hr />
            <h4>My Vision</h4>
            <p>To attain success in IT services.</p>
            <br />
            <h4>The objective to achieve the vision</h4>
            <p>To achieve a key position based on hard work,
                ...
                organization. To achieve a key position based on hard work
                , dedication and utilizing ones own potentials.   I believe that the
                objective can achieved once one can harmonize himself to explore and create opportunities
                for learning, by setting growth target, work with peers through teamwork, endeavour for
                personal and professional development and mindful for valuable contribution towards the overall
                enhancement of the organization. </p>
        </div>
    )
}
let Experience = () => {
...
let About=()=>{
    return(
        <div>
            <h1>About Me</h1>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut perferendis quisquam qui. Officia, aliquid! Deleniti, eveniet fugit a aliquid magnam ea. Nobis vitae vel quidem veritatis assumenda ratione expedita sunt.</p>
        </div>
    )
}
